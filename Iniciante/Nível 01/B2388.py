...
qtd_intervalo = int(input())
lista_auxiliar = []
dist_total = 0

for i in range(qtd_intervalo):
    lista_auxiliar = input().split()
    tempo_velocidade = [int(j) for j in lista_auxiliar]
    dist_total += tempo_velocidade[0] * tempo_velocidade[1]
